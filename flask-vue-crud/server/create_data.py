...
connection = sqlite3.connect('/home/zach/flask-vue-crud/server/database.db')

with open('/home/zach/flask-vue-crud/server/schema.sql') as f:
...
total_count = 0
adjusted_time = 0
sample_data = pd.read_csv('/home/zach/flask-vue-crud/server/sampleTelemData.csv')
